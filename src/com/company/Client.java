...
//      Adding the image icon to the app.
        ImageIcon img3 = new ImageIcon(ClassLoader.getSystemResource("com/company/icons/2.png"));
//      Getting the image and setting size to that.
...
//        Adding a key listener for typing action.
        t1.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                Server.changeStatus(true);
            }

            @Override
            public void keyReleased(KeyEvent e) {
                Server.changeStatus(false);
            }
        });
